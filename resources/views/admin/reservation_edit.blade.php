                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin_reservation_update',['id'=>$data->id])}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select readonly class="form-control select2" name="category_id"
                                                        style="width: 100%;">
                                                    <option value="0" selected="selected">Main Service</option>
                                                    @foreach($datalist as $db)
                                                        <option readonly value="{{$db->id}}"
                                                                @if ($db->id  == $data->category_id) selected="selected" @endif >{{$db->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit"
                                                    ...
                                                    <span id="payment-button-amount">Update Service</span>
